...
<body>
    ...
    <main>
            ...
            <tr>
                ...
                <td style="width: 42%;">
                    <div class="erp-card">
                        ...
                        <div class="erp-row"><span class="erp-label">Incoterm</span><span class="erp-value">{{ $invoice->incoterm ?: '-' }}</span></div>
        ...
        <div class="erp-subject"><strong>Objet :</strong><span class="erp-subject-text">{{ $invoice->subject ?: '-' }}</span></div>
        ...
        <div class="amount-in-words">
            Arr&ecirc;t&eacute;e la pr&eacute;sente facture &agrave; la somme de : <strong>{{ \App\Support\NumberFormatter::moneyToWords($invoice->total, $currency) }}</strong>.
        </div>
