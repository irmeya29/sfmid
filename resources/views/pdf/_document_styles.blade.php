...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .erp-title-main .type { color: #2676B3; font-size: 22px; font-weight: 700; line-height: 1.02; text-transform: uppercase; }
    ...
    .erp-card { background: #fbfdff; border-left: 3px solid #2676B3; min-height: 82px; padding: 8px 10px; }
    ...
    .erp-card-name { color: #10203f; font-size: 12.8px; font-weight: 700; margin-bottom: 3px; text-transform: uppercase; }
