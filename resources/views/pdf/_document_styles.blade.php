...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .document-meta-strip { background: #f8fbfd; border: 1px solid #dbe3ea; margin-top: 8px; padding: 6px 8px; text-align: center; }
    .document-meta-strip span { display: inline-block; margin: 0 10px; }
    .document-top { border-collapse: separate; border-spacing: 7px 0; margin: 0 0 14px; table-layout: fixed; width: 100%; }
    .document-top td { border: 0; padding: 0; vertical-align: top; }
    .doc-panel { background: #fff; border: 1px solid #cfd9e4; min-height: 78px; padding: 8px 9px; }
    .doc-panel-title { border: 2px solid #2676B3; color: #2676B3; display: inline-block; font-size: 12px; font-weight: 700; line-height: 1; margin-bottom: 6px; padding: 6px 10px; text-transform: uppercase; }
    .doc-panel-heading { color: #2676B3; font-size: 10px; font-weight: 700; letter-spacing: .3px; margin-bottom: 5px; text-transform: uppercase; }
    ...
    .document-lines td { border-bottom: 1px solid #e6edf3; border-right: 1px solid #edf2f7; min-height: 22px; padding: 5px 7px; }
    ...
    .total-box .grand td { background: #FFF3E7 !important; border-top: 2px solid #FA820A; color: #17324D; font-size: 12px; font-weight: 700; }
    .commercial-note { clear: both; color: #667085; font-size: 10px; padding-top: 12px; width: 56%; }
    .erp-title { border-collapse: collapse; margin: 0 0 8px; width: 100%; }
    .erp-title td { border-bottom: 0; padding: 0; vertical-align: middle; }
    .erp-title-main { border-left: 4px solid #FA820A; padding-left: 10px !important; }
    .erp-title-main .type { color: #2676B3; font-size: 12px; font-weight: 700; line-height: 1.12; text-transform: uppercase; }
    .erp-title-main .number { color: #667085; font-size: 10.5px; margin-top: 3px; }
    .erp-title-meta { text-align: right; }
    .erp-title-meta .meta-line { color: #334155; font-size: 10.5px; margin-bottom: 2px; }
    ...
    .erp-company-strip { background: #f8fbfd; border: 1px solid #dbe3ea; color: #334155; font-size: 9.7px; line-height: 1.35; margin: 0 0 9px; padding: 6px 8px; }
    .erp-company-strip span { display: inline-block; margin-right: 12px; }
    .erp-company-strip strong { color: #17324D; }
    .erp-info { border-collapse: separate; border-spacing: 0 0; margin: 0 0 12px; table-layout: fixed; width: 100%; }
    .erp-info td { border: 0; padding: 0; vertical-align: top; }
    .erp-info-gap { width: 12px; }
    .erp-card { background: #fbfdff; border-left: 3px solid #2676B3; min-height: 70px; padding: 6px 8px; }
    .erp-card-title { color: #2676B3; font-size: 10px; font-weight: 700; letter-spacing: .25px; margin-bottom: 5px; padding-bottom: 3px; text-transform: uppercase; }
    .erp-card-name { color: #10203f; font-size: 12px; font-weight: 700; margin-bottom: 3px; text-transform: uppercase; }
    .erp-row { line-height: 1.28; margin-top: 1px; }
    .erp-label { color: #667085; display: inline; line-height: 1.28; vertical-align: baseline; }
    .erp-label::after { content: " :"; }
    .erp-value { color: #27364a; display: inline; line-height: 1.28; margin-left: 3px; vertical-align: baseline; }
    .erp-subject { background: #f8fbfd; border-left: 3px solid #FA820A; color: #10203f; font-size: 11.5px; line-height: 1.35; margin: -2px 0 8px; padding: 7px 9px; page-break-inside: avoid; }
    .erp-subject strong { color: #2676B3; display: inline; font-size: 11.5px; line-height: 1.35; margin-right: 4px; text-transform: uppercase; vertical-align: baseline; }
    .erp-subject .erp-subject-text { display: inline; font-size: 11.5px; line-height: 1.35; vertical-align: baseline; }
    .erp-lines { border: 1px solid #cfd9e4; table-layout: fixed; }
    .erp-lines th { background: #2676B3; border-right: 1px solid rgba(255,255,255,.28); color: #fff; font-size: 9.4px; font-weight: 700; padding: 6px 7px; text-transform: uppercase; }
    .erp-lines th:last-child { border-right: 0; }
    .erp-lines td { border-bottom: 1px solid #e6edf3; line-height: 1.28; padding: 5px 7px; }
    ...
    .erp-after-lines { clear: both; margin-top: 12px; width: 100%; }
    ...
    .erp-totals td { background: #fff !important; border-bottom: 1px solid #e6edf3; padding: 6px 9px; }
    .erp-totals tr:last-child td { border-bottom: 0; }
    .erp-totals .grand td { background: #2676B3 !important; border-top: 2px solid #FA820A; color: #fff; font-size: 12px; font-weight: 700; }
    .erp-clear { clear: both; }
    .amount-in-words { clear: both; color: #10203f; font-size: 10.5px; line-height: 1.45; margin-top: 14px; padding: 0; page-break-inside: avoid; }
    .amount-in-words strong { color: #17324D; text-transform: uppercase; }
    .stamp-area { clear: both; margin-top: 28px; page-break-inside: avoid; text-align: right; }
    .stamp-box { border: 1px dashed #94a3b8; display: inline-block; height: 92px; padding: 8px; text-align: center; vertical-align: top; width: 230px; }
    ...
    footer { bottom: -3.65cm; color: #667085; font-size: 8.5px; left: -1.35cm; position: fixed; right: -1.35cm; text-align: center; }
    ...
    .company { color: #2676B3; font-size: 12px; font-weight: 700; text-transform: uppercase; }
    .logo-box { border: 1px solid #dbe3ea; color: #2676B3; display: inline-block; font-size: 12px; font-weight: 700; min-height: 34px; line-height: 32px; margin-bottom: 5px; padding: 0 10px; text-align: center; }
    .logo-box img { max-height: 38px; max-width: 120px; }
    h1 { color: #2676B3; font-size: 12px; font-weight: 700; letter-spacing: .5px; text-align: center; text-transform: uppercase; }
    h2 { color: #2676B3; font-size: 12px; font-weight: 600; margin: 0 0 8px; }
    .muted { color: #667085; }
    ...
    main { padding-top: 8px; position: relative; }
    .section { margin-top: 16px; page-break-inside: avoid; }
    .box { background: #f8fbfd; border: 1px solid #dbe3ea; border-radius: 6px; min-height: 82px; padding: 8px; }
    ...
    .totals .grand td { background: #FFF3E7 !important; border-top: 2px solid #FA820A; color: #17324D; font-size: 12px; font-weight: 700; padding-top: 8px; }
    .note-box { background: #f8fbfd; border: 1px solid #dbe3ea; border-radius: 6px; clear: both; padding: 10px; page-break-inside: avoid; }
    .arrete { background: #f8fbfd; border: 1px solid #dbe3ea; clear: both; margin-top: 18px; padding: 8px; text-align: center; }
    .signatures { margin-top: 22px; page-break-inside: avoid; width: 100%; }
    .signature { display: inline-block; text-align: center; vertical-align: top; width: 31%; }
    .signature + .signature { margin-left: 2.6%; }
    .signature-line { border-top: 1px solid #475569; color: #10203f; margin-top: 32px; padding-top: 6px; }
    .invoice-summary { background: #f8fbfd; border: 1px solid #dbe3ea; margin-top: 12px; width: 100%; }
    .invoice-summary td { border-bottom: 0; padding: 8px 10px; }
